...
def adding():
    ...
    while True:
        def info():
                ...
                while True:
                    if interation >= 0:
                        ...
                        if ask == "yes":
                            ...
                            for i in people_list:
                                print(i)
                            print(green, "\n\nDone! See you all on the Ground 👍 😄\n\n", white)
                            exit()
                        elif ask == "no":
                            os.system("cls")
                            print(green, "\n\nSaving...", white)
            ...
            os.system("cls")
        print(magenta, "\nWelcome to our Cricket Club! 👍😄", white)
        print(blue, "<--------------------------------->\n\n", white)
        print(red, "if an unexpected error occurred please make your team again (run the programe again 😅)", white)
        print("---------------------------------------------------------")
        first_name = input("\n\n\nEnter your first name: ").strip().title()
        last_name = input("\nEnter your last name: ").strip().title()
